...
//CLIENTES
			...
			$conn = sqlsrv_connect( db2_ip, array( "Database"=>db2_dbn, "UID"=>db2_usuario, "PWD"=>db2_clave, "CharacterSet" => "UTF-8") );	if( $conn === false ) { echo mensaje("Error al Conectar a la Base de Datos [DB:102]","danger");exit;}
...
/* commit transaction */
if (!$mysqli->commit()) {
    echo "ERROR al sincronizar los datos";
    exit();
