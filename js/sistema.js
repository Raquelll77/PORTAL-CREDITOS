...
$("#GeoAPI").html("<iframe style=\"width: 400px; height: 400px\" frameborder=\"0\" scrolling=\"no\" marginheight=\"0\" marginwidth=\"0\" src=\"http://maps.google.com/?ll=" + gps + "&z=16&output=embed\"></iframe>");
$('#GeoAPI').show();
}
...
function marcar_verificado_gestion(n,cid) {
	 ...
	 var respuesta=  $.ajax({ 
			        type: "GET",
			        url: 'creditos_gestion.php?cid='+cid+'&a=5x2c&n='+n,
			        async: false,
			    }).responseText;
