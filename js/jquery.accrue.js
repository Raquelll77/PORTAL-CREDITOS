...
;(function( $, window, document, undefined ){
    ...
    $.fn.accrue.options = {
        ...
        field_titles: {
            amount: "Total Prestamo",
            rate: "Tasa",
            rate_compare: "Tasa de comparacion",
            term: "Plazo"
        },
        ...
        field_comments: {
            ...
            rate: "",
            rate_compare: "",
            term: "Formato: 12m, 36m, 1y, 2y"
        },
        response_output_div: ".results",
        response_basic: 
            '<p><strong>Pago Mensual:</strong><br />$%payment_amount%</p>'+
            '<p><strong>Numero de Cuotas:</strong><br />%num_payments%</p>'+
            '<p><strong>Total Pago:</strong><br />$%total_payments%</p>'+
            '<p><strong>Total Interes:</strong><br />$%total_interest%</p>',
        response_compare: '<p class="total-savings">Save $%savings% in interest!</p>',
        error_text: '<p class="error">Ingrese todos los campos.</p>',
    ...
    var calculateAmortization = function( elem, options, output_elem ){
        ...
        if ( loan_info!==0 ) {
            ...
            var output_content = '<table class="accrue-amortization table table-striped">'+
                    '<tr>'+
                    '<th class="accrue-payment-number">#</th>'+
                    '<th class="accrue-payment-amount">Cuota</th>'+
                    '<th class="accrue-total-interest">Interes</th>'+
                    '<th class="accrue-total-payments">Total Pagado</th>'+
                    '<th class="accrue-balance">Saldo</th>'+
                    '</tr>',
