    ...
    $result = $conn->query($sql);
     ...
     if ($result->num_rows > 0) {
        ...
        $listas_tipos_clientes = [
            "PEP","Publico no PEP","Privado","Estudiante","Ama de Casa","Pensionado",
            "Independiente Formal","Informal","APNFD","Registrada","No Registrada",
            "Extranjero Residente","Extranjero no Residente","Otro"
        ];
        ...
        $lista_tipo_empleo = [
            "Asalariado","Independiente","Comerciante/Negocio Propio","Otro"
        ];
